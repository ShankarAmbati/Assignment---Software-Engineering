...
public class UserController {
	...
	public String registerUser(User user, Model model) {
		...
		isPasswordCompliant = userService.checkPassword(user); // Validating the password as per the defined password
																// policy.
		if (isPasswordCompliant == 0) { // Password does not matches with the defined password policy.
			...
			return usercontroller.registration(model); // Return to registration page with the customer message
